...
public abstract class FFTFactory {
    ...
    public static class JavaFFT implements Transform {
        ...
        private final int[][] FFT_BIT_TABLE = new int[MAX_FAST_BITS][];
        private int numberOfSamples;
        private int[] reverseIndices;
        ...
        int getNumberOfNeededBits(final int powerOfTwo) {
            for (int i = 0; true; i++) {
        ...
        int reverseBits(final int index, final int numberOfBits) {
            int ind = index;
            int rev = 0;
        ...
        int fastReverseBits(final int index, final int numberOfBits) {
        ...
        boolean isPowerOfTwo(final int number) {
